...
import { h, MaquetteComponent, Projector } from 'maquette';
...
describe('Original projector functionality', () => {
  ...
  describe('Event handlers', () => {
    ...
    it('allows for eventHandlers to be changed', () => allowsForEventHandlersToBeChanged(createAdvancedProjector));
    ...
    it('allows for eventHandlers to be changed on IE11', () => {
      ...
      try {
        ...
        let createProjectorImpl = require('../src/projector').createAdvancedProjector;
